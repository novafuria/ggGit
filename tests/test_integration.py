...
class TestComponentIntegration:
    ...
    def test_argument_validator_integration(
        self, argument_validator, sample_validation_data
    ):
...
class TestErrorHandlingIntegration:
    ...
    def test_error_propagation_through_base_command(
        self, concrete_command, mock_click_echo
    ):
    ...
    def test_validation_error_handling(self, argument_validator):
        ...
        # Test invalid scope
        with pytest.raises(
            ValueError, match="Scope must contain only lowercase letters"
        ):
...
class TestGitIntegration:
    ...
    def test_git_interface_return_types(self, git_interface):
        ...
        with pytest.raises(
            ValueError, match="La lista de archivos no puede estar vacía"
        ):
